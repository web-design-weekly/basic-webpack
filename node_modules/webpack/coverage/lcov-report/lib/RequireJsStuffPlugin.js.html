...
<html lang="en">
<head>
    <title>Code coverage report for lib\RequireJsStuffPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\RequireJsStuffPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; RequireJsStuffPlugin.js</div>
</div>
<div class="body">
...
&nbsp;
	...
	compiler.parser.plugin("expression requirejs.onError", <span class="fstat-no" title="function not covered" >function(expr) {</span>
<span class="cstat-no" title="statement not covered" >		var dep = new ConstDependency(JSON.stringify("__webpack_require__.onError"), expr.range);</span>
