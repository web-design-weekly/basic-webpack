...
<html lang="en">
<head>
    <title>Code coverage report for lib\optimize\CommonsChunkPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\optimize\CommonsChunkPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\optimize\</a> &#187; CommonsChunkPlugin.js</div>
</div>
<div class="body">
...
function CommonsChunkPlugin(chunkName, filenameTemplate, entryPoints, minCount) {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if(typeof entryPoints === "number") {
<span class="cstat-no" title="statement not covered" >		minCount = entryPoints;</span>
<span class="cstat-no" title="statement not covered" >		entryPoints = undefined;</span>
	}
