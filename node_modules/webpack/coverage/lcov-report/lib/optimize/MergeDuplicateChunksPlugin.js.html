...
<html lang="en">
<head>
    <title>Code coverage report for lib\optimize\MergeDuplicateChunksPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\optimize\MergeDuplicateChunksPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\optimize\</a> &#187; MergeDuplicateChunksPlugin.js</div>
</div>
<div class="body">
	...
	compiler.plugin("compilation", function(compilation) {
		compilation.plugin("optimize-chunks", function(chunks) {
			...
			chunks.slice().forEach(function(chunk) {
				...
				if(map[ident]) {
					<span class="missing-if-branch" title="else path not taken" >E</span>if(map[ident].integrate(chunk, "duplicate"))
