...
<html lang="en">
<head>
    <title>Code coverage report for lib\RequestShortener.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\RequestShortener.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; RequestShortener.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">23362</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-yes">23362</span>
<span class="cline-any cline-yes">12978</span>
<span class="cline-any cline-yes">23362</span>
<span class="cline-any cline-yes">23362</span>
<span class="cline-any cline-yes">23362</span>
<span class="cline-any cline-yes">23362</span>
...
function RequestShortener(directory) {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if(/[\/\\]$/.test(directory)) <span class="cstat-no" title="statement not covered" >directory = directory.substr(0, directory.length - 1);</span>
	<span class="missing-if-branch" title="else path not taken" >E</span>if(directory) {
...
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if(/[\/\\]$/.test(parentDirectory)) <span class="cstat-no" title="statement not covered" >parentDirectory = parentDirectory.substr(0, parentDirectory.length - 1);</span>
	<span class="missing-if-branch" title="else path not taken" >E</span>if(parentDirectory &amp;&amp; parentDirectory !== directory) {
...
&nbsp;
	<span class="missing-if-branch" title="else path not taken" >E</span>if(__dirname.length &gt;= 2) {
...
RequestShortener.prototype.shorten = function(request) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if(!request)
<span class="cstat-no" title="statement not covered" >		return request;</span>
	if(this.buildinsAsModule &amp;&amp; this.buildinsRegExp)
		request = request.replace(this.buildinsRegExp, "!(webpack)");
	<span class="missing-if-branch" title="else path not taken" >E</span>if(this.currentDirectoryRegExp)
		request = request.replace(this.currentDirectoryRegExp, "!.");
	<span class="missing-if-branch" title="else path not taken" >E</span>if(this.parentDirectoryRegExp)
