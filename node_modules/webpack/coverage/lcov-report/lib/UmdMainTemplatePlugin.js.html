...
<html lang="en">
<head>
    <title>Code coverage report for lib\UmdMainTemplatePlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\UmdMainTemplatePlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; UmdMainTemplatePlugin.js</div>
</div>
<div class="body">
...
&nbsp;
function UmdMainTemplatePlugin(name) {
	this.name = name;
}
	...
	mainTemplate.plugin("render", function(source, chunk, hash) {
		...
		function replaceKeys(str) {
			return (str
				...
				.replace(Template.REGEXP_NAME, chunk.name || <span class="branch-1 cbranch-no" title="branch not covered" >chunk.id)</span>);
		}
		...
		return new ConcatSource(new OriginalSource(
			...
			:
<span class="branch-1 cbranch-no" title="branch not covered" >			"		var a = factory();\n"</span>
			) +
	...
	mainTemplate.plugin("global-hash", function(chunk) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(Template.REGEXP_HASH.test([].concat(this.name || "").join("|")))
