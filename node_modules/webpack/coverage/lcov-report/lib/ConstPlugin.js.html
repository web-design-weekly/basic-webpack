...
<html lang="en">
<head>
    <title>Code coverage report for lib\ConstPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\ConstPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; ConstPlugin.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">484</span>
<span class="cline-any cline-yes">7261</span>
<span class="cline-any cline-yes">7261</span>
<span class="cline-any cline-yes">7261</span>
...
ConstPlugin.prototype.apply = function(compiler) {
	...
	compiler.parser.plugin("statement if", function(statement) {
		...
		if(typeof bool === "boolean") {
			<span class="missing-if-branch" title="else path not taken" >E</span>if(statement.test.type !== "Literal")
	...
	compiler.parser.plugin("expression ?:", function(expression) {
		...
		var bool = param.asBool();
		if(typeof bool === "boolean") {
			<span class="missing-if-branch" title="else path not taken" >E</span>if(expression.test.type !== "Literal")
				this.state.current.addDependency(new ConstDependency(bool + "", param.range));
			return bool;
		}
	});
	compiler.parser.plugin("evaluate Identifier __resourceQuery", function(expr) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(!this.state.module) <span class="cstat-no" title="statement not covered" >return;</span>
