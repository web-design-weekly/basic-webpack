...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\Template.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.33% <small>(70 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; Template.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">6439</span>
<span class="cline-any cline-yes">752</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5687</span>
<span class="cline-any cline-yes">5687</span>
<span class="cline-any cline-yes">5673</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3963</span>
<span class="cline-any cline-yes">2959</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">734</span>
<span class="cline-any cline-yes">2999</span>
<span class="cline-any cline-yes">2999</span>
<span class="cline-any cline-yes">734</span>
<span class="cline-any cline-yes">734</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">646</span>
<span class="cline-any cline-yes">3288</span>
<span class="cline-any cline-yes">3288</span>
<span class="cline-any cline-yes">3288</span>
<span class="cline-any cline-yes">3288</span>
<span class="cline-any cline-yes">2876</span>
...
function Template(outputOptions) {
	Tapable.call(this);
	this.outputOptions = outputOptions || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
}
...
Template.prototype.prefix = function(str, prefix) {
	<span class="missing-if-branch" title="else path not taken" >E</span>if(Array.isArray(str)) {
		str = str.join("\n");
	}
	str = str.trim();
	...
	return (str[0] === "\n" ? <span class="branch-0 cbranch-no" title="branch not covered" >"" </span>: prefix) + str.replace(/\n([^\n])/g, "\n" + prefix + "$1");
};
&nbsp;
...
Template.prototype.renderChunkModules = function(chunk, moduleTemplate, dependencyTemplates, prefix) {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if(chunk.modules.length === 0) {
<span class="cstat-no" title="statement not covered" >		source.add("[]");</span>
<span class="cstat-no" title="statement not covered" >		return source;</span>
	...
	if(arrayOverhead &lt; objectOverhead) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if(minId !== 0) <span class="cstat-no" title="statement not covered" >source.add("Array(" + minId + ").concat(");</span>
		source.add("[\n");
		var modules = {};
		...
		source.add("\n" + prefix + "]");
		<span class="missing-if-branch" title="if path not taken" >I</span>if(minId !== 0) <span class="cstat-no" title="statement not covered" >source.add(")");</span>
	} else {
		// Render an object
		source.add("{\n");
