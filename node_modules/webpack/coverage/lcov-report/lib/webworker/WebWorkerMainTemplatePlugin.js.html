...
<html lang="en">
<head>
    <title>Code coverage report for lib\webworker\WebWorkerMainTemplatePlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\webworker\WebWorkerMainTemplatePlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\webworker\</a> &#187; WebWorkerMainTemplatePlugin.js</div>
</div>
<div class="body">
...
WebWorkerMainTemplatePlugin.prototype.apply = function(mainTemplate) {
	mainTemplate.plugin("local-vars", function(source, chunk, hash) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if(chunk.chunks.length &gt; 0) {
...
<span class="cstat-no" title="statement not covered" >		return source;</span>
	...
	mainTemplate.plugin("require-ensure", function(_, chunk, hash) {
		...
		var chunkFilename = this.outputOptions.chunkFilename || <span class="branch-1 cbranch-no" title="branch not covered" >"[id]." + filename;</span>
		return this.asString([
