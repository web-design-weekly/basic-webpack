...
<html lang="en">
<head>
    <title>Code coverage report for lib\ModuleParseError.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\ModuleParseError.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; ModuleParseError.js</div>
</div>
<div class="body">
...
function ModuleParseError(module, source, err) {
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if(typeof err.lineNumber === "number") {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(/[\0\u0001\u0002\u0003\u0004\u0005\u0006\u0007]/.test(source)) { // binary file
<span class="cstat-no" title="statement not covered" >			this.message += "\n(Source code omitted for this binary file)";</span>
		} else {
			source = source.split("\n");
