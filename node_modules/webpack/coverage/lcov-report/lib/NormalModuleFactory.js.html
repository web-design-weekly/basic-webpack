...
<html lang="en">
<head>
    <title>Code coverage report for lib\NormalModuleFactory.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\NormalModuleFactory.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; NormalModuleFactory.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3887</span>
<span class="cline-any cline-yes">3887</span>
<span class="cline-any cline-yes">3887</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">3857</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3887</span>
<span class="cline-any cline-yes">3804</span>
<span class="cline-any cline-yes">3804</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3804</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3466</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">14803</span>
...
function NormalModuleFactory(context, resolvers, parser, options) {
	...
	this.context = context || <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
}
...
NormalModuleFactory.prototype.create = function(context, dependency, callback) {
	context = context || <span class="branch-1 cbranch-no" title="branch not covered" >this.context;</span>
...
&nbsp;
			...
			if(noAutoLoaders) {
				...
				async.parallel([
					this.resolveRequestArray.bind(this, context, noPostAutoLoaders ? <span class="branch-0 cbranch-no" title="branch not covered" >[] </span>: this.postLoaders.match(resource), this.resolvers.loader),
...
NormalModuleFactory.prototype.resolveRequestArray = function resolveRequestArray(context, array, resolver, callback) {
	...
	async.map(array, function(item, callback) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(item === "" || item[0] === "?")
