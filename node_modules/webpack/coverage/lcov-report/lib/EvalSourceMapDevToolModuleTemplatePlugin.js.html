...
<html lang="en">
<head>
    <title>Code coverage report for lib\EvalSourceMapDevToolModuleTemplatePlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\EvalSourceMapDevToolModuleTemplatePlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; EvalSourceMapDevToolModuleTemplatePlugin.js</div>
</div>
<div class="body">
...
function EvalSourceMapDevToolModuleTemplatePlugin(compilation, sourceMapComment, moduleFilenameTemplate) {
	...
	this.sourceMapComment = sourceMapComment || <span class="branch-1 cbranch-no" title="branch not covered" >"//@ sourceMappingURL=[url]";</span>
...
<span class="cstat-no" title="statement not covered" >			return source;</span>
		...
		moduleFilenames = ModuleFilenameHelpers.replaceDuplicates(moduleFilenames, <span class="fstat-no" title="function not covered" >function(filename, i, n) {</span>
<span class="cstat-no" title="statement not covered" >			for(var j = 0; j &lt; n; j++)</span>
<span class="cstat-no" title="statement not covered" >				filename += "*";</span>
<span class="cstat-no" title="statement not covered" >			return filename;</span>
		});
		sourceMap.sources = moduleFilenames;
		<span class="missing-if-branch" title="else path not taken" >E</span>if(sourceMap.sourcesContent) {
