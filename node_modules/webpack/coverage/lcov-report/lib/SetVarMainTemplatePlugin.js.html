...
<html lang="en">
<head>
    <title>Code coverage report for lib\SetVarMainTemplatePlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\SetVarMainTemplatePlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; SetVarMainTemplatePlugin.js</div>
</div>
<div class="body">
...
SetVarMainTemplatePlugin.prototype.apply = function(mainTemplate) {
	mainTemplate.plugin("render", function(source, chunk, hash) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if(this.copyObject) {
<span class="cstat-no" title="statement not covered" >			return new ConcatSource("(function(e, a) { for(var i in a) e[i] = a[i]; }(" +</span>
	...
	mainTemplate.plugin("global-hash", function(chunk) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(Template.REGEXP_HASH.test(this.varExpression || <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>)
