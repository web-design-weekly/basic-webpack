...
<html lang="en">
<head>
    <title>Code coverage report for lib\node\NodeEnvironmentPlugin.js</title>
    <meta charset="utf-8">
...
NodeEnvironmentPlugin.prototype.apply = function(compiler) {
	...
	compiler.plugin("run", function(compiler, callback) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if(compiler.inputFileSystem === inputFileSystem)
