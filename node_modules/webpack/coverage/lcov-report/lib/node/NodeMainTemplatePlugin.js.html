...
<html lang="en">
<head>
    <title>Code coverage report for lib\node\NodeMainTemplatePlugin.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">lib\node\NodeMainTemplatePlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\node\</a> &#187; NodeMainTemplatePlugin.js</div>
</div>
<div class="body">
...
NodeMainTemplatePlugin.prototype.apply = function(mainTemplate) {
	...
	mainTemplate.plugin("require-ensure", function(_, chunk, hash) {
		var filename = this.outputOptions.filename || <span class="branch-1 cbranch-no" title="branch not covered" >"bundle.js";</span>
	...
	mainTemplate.plugin("hot-bootstrap", function(source, chunk, hash) {
		...
		var currentHotUpdateMainFilename = JSON.stringify(hotUpdateMainFilename)
			.replace(Template.REGEXP_HASH, "\" + " + this.renderCurrentHashCode(hash) + " + \"");
		return Template.getFunctionContent(self.asyncChunkLoading ? <span class="fstat-no" title="function not covered" >function() {</span>
<span class="fstat-no" title="function not covered" >			function hotDownloadUpdateChunk(chunkId) {</span>
<span class="cstat-no" title="statement not covered" >				var filename = require("path").join(__dirname, $hotChunkFilename$);</span>
<span class="cstat-no" title="statement not covered" >				require("fs").readFile(filename, "utf-8", <span class="fstat-no" title="function not covered" >function(err, content) {</span></span>
<span class="cstat-no" title="statement not covered" >					if(err) {</span>
<span class="cstat-no" title="statement not covered" >						if($require$.onError)</span>
<span class="cstat-no" title="statement not covered" >							return $require$.onError(err);</span>
						else
...
<span class="cstat-no" title="statement not covered" >					require("vm").runInThisContext("(function(exports) {" + content + "\n})", filename)(chunk);</span>
<span class="cstat-no" title="statement not covered" >					hotAddUpdateChunk(chunk.id, chunk.modules);</span>
				});
			}
&nbsp;
<span class="fstat-no" title="function not covered" >			function hotDownloadManifest(callback) {</span>
<span class="cstat-no" title="statement not covered" >				var filename = require("path").join(__dirname, $hotMainFilename$);</span>
<span class="cstat-no" title="statement not covered" >				require("fs").readFile(filename, "utf-8", <span class="fstat-no" title="function not covered" >function(err, content) {</span></span>
...
<span class="cstat-no" title="statement not covered" >						var update = JSON.parse(content);</span>
					} catch(e) {
<span class="cstat-no" title="statement not covered" >						return callback(e);</span>
					}
<span class="cstat-no" title="statement not covered" >					callback(null, update);</span>
				});
			}
...
<span class="fstat-no" title="function not covered" >			function hotDownloadUpdateChunk(chunkId) {</span>
<span class="cstat-no" title="statement not covered" >				var chunk = require("./" + $hotChunkFilename$);</span>
<span class="cstat-no" title="statement not covered" >				hotAddUpdateChunk(chunk.id, chunk.modules);</span>
			}
&nbsp;
<span class="fstat-no" title="function not covered" >			function hotDownloadManifest(callback) {</span>
<span class="cstat-no" title="statement not covered" >				try {</span>
<span class="cstat-no" title="statement not covered" >					var update = require("./" + $hotMainFilename$);</span>
				} catch(e) {
