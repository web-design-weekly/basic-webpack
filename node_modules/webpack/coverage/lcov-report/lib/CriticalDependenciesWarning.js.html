...
<html lang="en">
<head>
    <title>Code coverage report for lib\CriticalDependenciesWarning.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\CriticalDependenciesWarning.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; CriticalDependenciesWarning.js</div>
</div>
<div class="body">
...
function CriticalDependenciesWarning(module, dependencies) {
	...
	this.message += dependencies.filter(function(d) {
		return typeof d.critical === "string" || <span class="branch-1 cbranch-no" title="branch not covered" >d.loc;</span>
	}).map(function(dep) {
		var line = [];
		<span class="missing-if-branch" title="else path not taken" >E</span>if(dep.loc) line.push(dep.loc.start.line + ":" + dep.loc.start.column + "-" +
			(dep.loc.start.line !== dep.loc.end.line ? dep.loc.end.line + ":" : "") + dep.loc.end.column);
		<span class="missing-if-branch" title="else path not taken" >E</span>if(typeof dep.critical === "string") line.push(dep.critical);
		return "\n" + line.join(" ");
	}).join("");
