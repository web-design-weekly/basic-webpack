...
<html lang="en">
<head>
    <title>Code coverage report for lib\CompatibilityPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\CompatibilityPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; CompatibilityPlugin.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">484</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3453</span>
...
CompatibilityPlugin.prototype.apply = function(compiler) {
	...
	compiler.parser.plugin("call require", function(expr) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if(second.asBool() !== true) <span class="cstat-no" title="statement not covered" >return;</span>
		var dep = new ConstDependency("require", expr.callee.range);
		dep.loc = expr.loc;
		<span class="missing-if-branch" title="else path not taken" >E</span>if(this.state.current.dependencies.length &gt; 1) {
			var last = this.state.current.dependencies[this.state.current.dependencies.length - 1];
			<span class="missing-if-branch" title="else path not taken" >E</span>if(last.critical &amp;&amp; last.request === "." &amp;&amp; last.userRequest === "." &amp;&amp; last.recursive)
