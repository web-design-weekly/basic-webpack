...
<html lang="en">
<head>
    <title>Code coverage report for lib\Chunk.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\Chunk.js</span></h1>
    <h2>
        
        Statements: <span class="metric">90.3% <small>(121 / 134)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">90.3% <small>(121 / 134)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; Chunk.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">5129</span>
<span class="cline-any cline-yes">1955</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3174</span>
<span class="cline-any cline-yes">3174</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">731</span>
<span class="cline-any cline-yes">731</span>
<span class="cline-any cline-yes">2996</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
&nbsp;
Chunk.prototype.removeChunk = <span class="fstat-no" title="function not covered" >function(chunk) {</span>
<span class="cstat-no" title="statement not covered" >	this._removeAndDo("chunks", chunk, "removeParent");</span>
};
&nbsp;
Chunk.prototype.removeParent = <span class="fstat-no" title="function not covered" >function(chunk) {</span>
<span class="cstat-no" title="statement not covered" >	this._removeAndDo("parents", chunk, "removeChunk");</span>
};
&nbsp;
...
Chunk.prototype.addBlock = function(block) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if(this.blocks.indexOf(block) &gt;= 0) {
...
Chunk.prototype.remove = function(reason) {
	...
	this.modules.slice().forEach(<span class="fstat-no" title="function not covered" >function(m) {</span>
<span class="cstat-no" title="statement not covered" >		m.removeChunk(this);</span>
	}, this);
	this.parents.forEach(function(c) {
		var idx = c.chunks.indexOf(this);
		<span class="missing-if-branch" title="else path not taken" >E</span>if(idx &gt;= 0) {
...
Chunk.prototype.integrate = function(other, reason) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if(!this.canBeIntegrated(other)) {
<span class="cstat-no" title="statement not covered" >		return false;</span>
	}
&nbsp;
	...
	moveChunks(other.chunks, "parents", function(c) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(c !== this &amp;&amp; this.addChunk(c)) {
<span class="cstat-no" title="statement not covered" >			c.addParent(this);</span>
		}	
	}.bind(this));
	...
	other.origins.forEach(function(origin) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if(!origin.reasons) {
			origin.reasons = [reason];
		} else <span class="cstat-no" title="statement not covered" >if(origin.reasons[0] !== reason) {</span>
<span class="cstat-no" title="statement not covered" >			origin.reasons.unshift(reason);</span>
		}
...
Chunk.prototype.updateHash = function(hash) {
	hash.update(this.id + " ");
	hash.update(this.ids ? this.ids.join(",") : <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>;
...
&nbsp;
	...
	return modulesSize * (this.initial ? <span class="branch-0 cbranch-no" title="branch not covered" >ENTRY_CHUNK_MULTIPLICATOR </span>: 1) + CHUNK_OVERHEAD;
};
&nbsp;
Chunk.prototype.canBeIntegrated = function(other) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if(other.initial) {
<span class="cstat-no" title="statement not covered" >		return false;</span>
	}
	<span class="missing-if-branch" title="if path not taken" >I</span>if(this.initial) {
<span class="cstat-no" title="statement not covered" >		if(other.parents.length !== 1 || other.parents[0] !== this) {</span>
<span class="cstat-no" title="statement not covered" >			return false;</span>
		}
	}
	return true;
...
&nbsp;
	...
	return modulesSize * (this.initial || other.initial ? <span class="branch-0 cbranch-no" title="branch not covered" >ENTRY_CHUNK_MULTIPLICATOR </span>: 1) + CHUNK_OVERHEAD;
};
&nbsp;
Chunk.prototype.toString = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >	return "Chunk[" + this.modules.join() + "]";</span>
};</pre></td></tr>
</table></pre>
