...
<html lang="en">
<head>
    <title>Code coverage report for lib\APIPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\APIPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; APIPlugin.js</div>
</div>
<div class="body">
...
APIPlugin.prototype.apply = function(compiler) {
	...
	Object.keys(REPLACEMENTS).forEach(function(key) {
		...
		compiler.parser.plugin("evaluate typeof "+key, <span class="fstat-no" title="function not covered" >function(expr) {</span>
<span class="cstat-no" title="statement not covered" >			return new BasicEvaluatedExpression().setString(REPLACEMENT_TYPES[key]).setRange(expr.range);</span>
		});
	});
	IGNORES.forEach(<span class="fstat-no" title="function not covered" >function(key) {</span>
<span class="cstat-no" title="statement not covered" >		compiler.parser.plugin(key, <span class="fstat-no" title="function not covered" >function(expr) {</span></span>
