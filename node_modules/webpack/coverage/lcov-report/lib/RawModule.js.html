...
<html lang="en">
<head>
    <title>Code coverage report for lib\RawModule.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\RawModule.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib\</a> &#187; RawModule.js</div>
</div>
<div class="body">
...
function RawModule(source, identifier, readableIdentifier) {
	...
	this.identifierStr = identifier || <span class="branch-1 cbranch-no" title="branch not covered" >this.sourceStr;</span>
	this.readableIdentifierStr = readableIdentifier || <span class="branch-1 cbranch-no" title="branch not covered" >this.identifierStr;</span>
	this.cacheable = true;
	this.built = false;
}
...
&nbsp;
RawModule.prototype.needRebuild = <span class="fstat-no" title="function not covered" >function(fileTimestamps, contextTimestamps) {</span>
...
&nbsp;
RawModule.prototype.createTemplate = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >	return new RawModule(this.sourceStr, "template of " + this.id);</span>
};
&nbsp;
RawModule.prototype.getTemplateArguments = <span class="fstat-no" title="function not covered" >function() {</span>
