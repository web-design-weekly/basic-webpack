...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\ContextDependencyHelpers.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\ContextDependencyHelpers.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; ContextDependencyHelpers.js</div>
</div>
<div class="body">
...
ContextDependencyHelpers.create = function(Dep, range, param, expr, options) {
	if(param.isWrapped() &amp;&amp; param.prefix.isString()) {
		...
		var postfix = param.postfix.isString() ? param.postfix.string : <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
		var prefixRange = param.prefix.range;
		var valueRange = [prefixRange ? prefixRange[1] : <span class="branch-1 cbranch-no" title="branch not covered" >param.range[0],</span> param.range[1]];
		...
		dep.loc = expr.loc;
		dep.prepend = prefix;
		dep.critical = options.wrappedContextCritical &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >"a part of the request of a dependency is an expression";</span>
		return dep;
	} else {
