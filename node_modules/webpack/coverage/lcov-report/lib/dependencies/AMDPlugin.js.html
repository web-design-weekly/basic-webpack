...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\AMDPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\AMDPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; AMDPlugin.js</div>
</div>
<div class="body">
...
&nbsp;
	...
	compiler.parser.plugin("evaluate typeof define.amd", <span class="fstat-no" title="function not covered" >function(expr) {</span>
<span class="cstat-no" title="statement not covered" >		return new BasicEvaluatedExpression().setString(typeof amdOptions).setRange(expr.range);</span>
	});
	compiler.parser.plugin("evaluate typeof require.amd", <span class="fstat-no" title="function not covered" >function(expr) {</span>
<span class="cstat-no" title="statement not covered" >		return new BasicEvaluatedExpression().setString(typeof amdOptions).setRange(expr.range);</span>
	});
	compiler.parser.plugin("evaluate Identifier define.amd", function(expr) {
		return new BasicEvaluatedExpression().setBoolean(true).setRange(expr.range);
	});
	compiler.parser.plugin("evaluate Identifier require.amd", <span class="fstat-no" title="function not covered" >function(expr) {</span>
<span class="cstat-no" title="statement not covered" >		return new BasicEvaluatedExpression().setBoolean(true).setRange(expr.range);</span>
	});
	setTypeof("define", "function");
	compiler.parser.plugin("can-rename define", <span class="fstat-no" title="function not covered" >function(expr) {</span>
