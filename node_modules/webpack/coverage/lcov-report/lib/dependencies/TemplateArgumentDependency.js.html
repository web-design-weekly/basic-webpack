...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\TemplateArgumentDependency.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\TemplateArgumentDependency.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; TemplateArgumentDependency.js</div>
</div>
<div class="body">
...
TemplateArgumentDependency.Template.prototype.apply = function(dep, source, outputOptions, requestShortener, dependencyTemplates) {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if(!template) <span class="cstat-no" title="statement not covered" >throw new Error("No template for dependency: " + d.Class.name);</span>
	<span class="missing-if-branch" title="if path not taken" >I</span>if(!template.applyAsTemplateArgument) <span class="cstat-no" title="statement not covered" >throw new Error("Template cannot be applied as TemplateArgument: " + d.Class.name);</span>
