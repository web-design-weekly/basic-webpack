...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\RequireResolveHeaderDependency.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\RequireResolveHeaderDependency.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; RequireResolveHeaderDependency.js</div>
</div>
<div class="body">
...
function RequireResolveHeaderDependency(range) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if(!Array.isArray(range)) <span class="cstat-no" title="statement not covered" >throw new Error("range must be valid");</span>
...
&nbsp;
RequireResolveHeaderDependency.Template.prototype.applyAsTemplateArgument = <span class="fstat-no" title="function not covered" >function(name, dep, source, outputOptions, requestShortener) {</span>
<span class="cstat-no" title="statement not covered" >	source.replace(dep.range[0], dep.range[1]-1, "/*require.resolve*/");</span>
};
&nbsp;</pre></td></tr>
</table></pre>
