...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\RequireContextDependencyParserPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\RequireContextDependencyParserPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; RequireContextDependencyParserPlugin.js</div>
</div>
<div class="body">
...
module.exports = AbstractPlugin.create({
	"call require.context": function(expr) {
		...
		case 3:
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if(!regExpExpr.isRegExp()) <span class="cstat-no" title="statement not covered" >return;</span>
			regExp = regExpExpr.regExp;
			// fall through
		case 2:
			var recursiveExpr = this.evaluateExpression(expr.arguments[1]);
			<span class="missing-if-branch" title="if path not taken" >I</span>if(!recursiveExpr.isBoolean()) <span class="cstat-no" title="statement not covered" >return;</span>
			recursive = recursiveExpr.bool;
			// fall through
		case 1:
			var requestExpr = this.evaluateExpression(expr.arguments[0]);
			<span class="missing-if-branch" title="if path not taken" >I</span>if(!requestExpr.isString()) <span class="cstat-no" title="statement not covered" >return;</span>
