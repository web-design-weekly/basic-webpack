...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\RequireResolveDependencyParserPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\RequireResolveDependencyParserPlugin.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">84.21% <small>(32 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; RequireResolveDependencyParserPlugin.js</div>
</div>
<div class="body">
...
RequireResolveDependencyParserPlugin.prototype.apply = function(parser) {
	...
	parser.plugin("call require.resolve", function(expr) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(expr.arguments.length !== 1) <span class="cstat-no" title="statement not covered" >return;</span>
		var param = this.evaluateExpression(expr.arguments[0]);
		<span class="missing-if-branch" title="if path not taken" >I</span>if(param.isConditional()) {
<span class="cstat-no" title="statement not covered" >			param.options.forEach(<span class="fstat-no" title="function not covered" >function(option) {</span></span>
<span class="cstat-no" title="statement not covered" >				var result = this.applyPluginsBailResult("call require.resolve:item", expr, option);</span>
<span class="cstat-no" title="statement not covered" >				if(result === undefined) {</span>
<span class="cstat-no" title="statement not covered" >					this.applyPluginsBailResult("call require.resolve:context", expr, option);</span>
				}
			}, this);
<span class="cstat-no" title="statement not covered" >			this.state.current.addDependency(new RequireResolveHeaderDependency(expr.callee.range));</span>
