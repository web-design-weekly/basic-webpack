...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\AMDRequireDependency.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\AMDRequireDependency.js</span></h1>
    <h2>
        
        Statements: <span class="metric">87.18% <small>(34 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; AMDRequireDependency.js</div>
</div>
<div class="body">
...
AMDRequireDependency.Template.prototype.apply = function(dep, source, outputOptions, requestShortener) {
	...
	} else <span class="missing-if-branch" title="if path not taken" >I</span>if(!depBlock.arrayRange &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >depBlock.functionRange)</span> {
<span class="cstat-no" title="statement not covered" >		if(typeof chunkId === "number") {</span>
<span class="cstat-no" title="statement not covered" >			source.replace(depBlock.outerRange[0], depBlock.functionRange[0]-1,</span>
				"__webpack_require__.e/* require */(" + chunkId + asComment(depBlock.chunkReason) + ", function(__webpack_require__) {(");
<span class="cstat-no" title="statement not covered" >			source.replace(depBlock.functionRange[1], depBlock.outerRange[1]-1, ".call(exports, __webpack_require__, exports, module));})");</span>
		} else {
<span class="cstat-no" title="statement not covered" >			source.replace(depBlock.outerRange[0], depBlock.functionRange[0]-1,</span>
				"!/* require */(" + asComment(depBlock.chunkReason));
<span class="cstat-no" title="statement not covered" >			source.replace(depBlock.functionRange[1], depBlock.outerRange[1]-1, ".call(exports, __webpack_require__, exports, module))");</span>
		}
	} else <span class="missing-if-branch" title="else path not taken" >E</span>if(depBlock.arrayRange &amp;&amp; depBlock.functionRange) {
		if(typeof chunkId === "number") {
			source.replace(depBlock.outerRange[0], depBlock.arrayRange[0]-1,
				"__webpack_require__.e/* require */(" + chunkId + asComment(depBlock.chunkReason) + ", function(__webpack_require__) { ");
