...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\CommonJsPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\CommonJsPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; CommonJsPlugin.js</div>
</div>
<div class="body">
...
&nbsp;
	...
	compiler.parser.plugin("evaluate typeof require", <span class="fstat-no" title="function not covered" >function(expr) {</span>
<span class="cstat-no" title="statement not covered" >		return new BasicEvaluatedExpression().setString("function").setRange(expr.range);</span>
	});
