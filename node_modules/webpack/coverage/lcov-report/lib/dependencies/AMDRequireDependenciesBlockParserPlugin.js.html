...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\AMDRequireDependenciesBlockParserPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\AMDRequireDependenciesBlockParserPlugin.js</span></h1>
    <h2>
        
        Statements: <span class="metric">91.26% <small>(94 / 103)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">93% <small>(93 / 100)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; AMDRequireDependenciesBlockParserPlugin.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">484</span>
<span class="cline-any cline-yes">484</span>
<span class="cline-any cline-yes">3433</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3340</span>
<span class="cline-any cline-yes">3340</span>
<span class="cline-any cline-yes">3340</span>
<span class="cline-any cline-yes">3340</span>
<span class="cline-any cline-yes">3340</span>
			...
			try {
				...
				if(expr.arguments[1].type === "FunctionExpression") {
					this.inScope(expr.arguments[1].params.filter(function(i) {
						...
						<span class="missing-if-branch" title="else path not taken" >E</span>if(expr.arguments[1].body.type === "BlockStatement")
							this.walkStatement(expr.arguments[1].body);
						else
<span class="cstat-no" title="statement not covered" >							this.walkExpression(expr.arguments[1].body);</span>
					}.bind(this));
				}
			} finally {
				this.state.current = old;
...
<span class="cstat-no" title="statement not covered" >					this.applyPluginsBailResult("call require:amd:context", expr, param);</span>
				}
			}, this);
			return true;
		} else if(param.isString()) {
			var dep, localModule;
			<span class="missing-if-branch" title="if path not taken" >I</span>if(param.string === "require") {
<span class="cstat-no" title="statement not covered" >				dep = new ConstDependency("__webpack_require__", param.string);</span>
			} else <span class="missing-if-branch" title="if path not taken" >I</span>if(["exports", "module"].indexOf(param.string) &gt;= 0) {
<span class="cstat-no" title="statement not covered" >				dep = new ConstDependency(param.string, param.range);</span>
	...
	parser.plugin("call require:amd:context", function(expr, param) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if(!dep) <span class="cstat-no" title="statement not covered" >return;</span>
		dep.loc = expr.loc;
		dep.optional = !!this.scope.inTry;
		this.state.current.addDependency(dep);
		return true;
