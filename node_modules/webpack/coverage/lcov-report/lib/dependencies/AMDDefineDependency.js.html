...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\AMDDefineDependency.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\AMDDefineDependency.js</span></h1>
    <h2>
        
        Statements: <span class="metric">85.42% <small>(41 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">80.49% <small>(33 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; AMDDefineDependency.js</div>
</div>
<div class="body">
...
AMDDefineDependency.Template.prototype.apply = function(dep, source, outputOptions, requestShortener) {
	...
	if(localModuleVar) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if(dep.objectRange &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!dep.functionRange)</span> {
			// define("name", {...})
			// =&gt; var XXX; !(XXX = {...})
<span class="cstat-no" title="statement not covered" >			source.insert(0, "var " + localModuleVar + ";");</span>
<span class="cstat-no" title="statement not covered" >			source.replace(dep.range[0], dep.objectRange[0]-1,</span>
				"!(" + localModuleVar + " = ");
<span class="cstat-no" title="statement not covered" >			source.replace(dep.objectRange[1], dep.range[1]-1, ")");</span>
		...
		} else <span class="missing-if-branch" title="else path not taken" >E</span>if(dep.arrayRange &amp;&amp; dep.functionRange &amp;&amp; !dep.objectRange) {
			// define("name", [], function() {...})
		...
		} else <span class="cstat-no" title="statement not covered" >if(dep.functionRange &amp;&amp; dep.objectRange) {</span>
			// define("name", abc)
...
<span class="cstat-no" title="statement not covered" >			source.insert(0, "var __WEBPACK_AMD_DEFINE_FACTORY__, " + localModuleVar + ";");</span>
<span class="cstat-no" title="statement not covered" >			source.replace(dep.range[0], dep.functionRange[0]-1,</span>
				"!(__WEBPACK_AMD_DEFINE_FACTORY__ = (");
<span class="cstat-no" title="statement not covered" >			source.replace(dep.functionRange[1], dep.range[1]-1, "), " + localModuleVar + " = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__))");</span>
		}
	} else {
		...
		} else <span class="missing-if-branch" title="else path not taken" >E</span>if(dep.functionRange &amp;&amp; dep.objectRange) {
			// define(["name", ]abc)
