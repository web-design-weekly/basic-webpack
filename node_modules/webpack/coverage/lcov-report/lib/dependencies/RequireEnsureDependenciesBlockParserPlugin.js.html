...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\RequireEnsureDependenciesBlockParserPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\RequireEnsureDependenciesBlockParserPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; RequireEnsureDependenciesBlockParserPlugin.js</div>
</div>
<div class="body">
...
module.exports = AbstractPlugin.create({
	"call require.ensure": function(expr) {
		...
		case 3:
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if(!chunkNameExpr.isString()) <span class="cstat-no" title="statement not covered" >return;</span>
		...
		case 2:
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if(!dependenciesExpr.isArray()) <span class="cstat-no" title="statement not covered" >return;</span>
			...
			try {
				...
				this.inScope([], function() {
					dependenciesExpr.items.forEach(function(ee) {
						<span class="missing-if-branch" title="else path not taken" >E</span>if(ee.isString()) {
...
<span class="cstat-no" title="statement not covered" >							failed = true;</span>
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if(failed) {
<span class="cstat-no" title="statement not covered" >					return;</span>
				}
				if(fnExpression.type === "FunctionExpression") {
					<span class="missing-if-branch" title="else path not taken" >E</span>if(fnExpression.body.type === "BlockStatement")
						this.walkStatement(fnExpression.body);
					else
<span class="cstat-no" title="statement not covered" >						this.walkExpression(fnExpression.body);</span>
				}
				old.addBlock(dep);
			} finally {
