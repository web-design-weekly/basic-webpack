...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\RequireIncludeDependencyParserPlugin.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\RequireIncludeDependencyParserPlugin.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; RequireIncludeDependencyParserPlugin.js</div>
</div>
<div class="body">
...
module.exports = AbstractPlugin.create({
	"call require.include": function(expr) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if(!param.isString()) <span class="cstat-no" title="statement not covered" >return;</span>
