...
<html lang="en">
<head>
    <title>Code coverage report for lib\dependencies\LabeledModuleDependency.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\dependencies\LabeledModuleDependency.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib\dependencies\</a> &#187; LabeledModuleDependency.js</div>
</div>
<div class="body">
...
LabeledModuleDependency.Template.prototype.apply = function(dep, source, outputOptions, requestShortener) {
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if(dep.module &amp;&amp; dep.module.meta &amp;&amp; dep.module.meta.exports) {
		...
		content += ";"
	} else <span class="cstat-no" title="statement not covered" >if(dep.module) {</span>
<span class="cstat-no" title="statement not covered" >		var content = require("./WebpackMissingModule").moduleMetaInfo(dep.request);</span>
	} else {
